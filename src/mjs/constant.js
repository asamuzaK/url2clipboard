...
export const COPY_TABS_SELECTED = "copySelectedTabsURL";
export const EXEC_COPY = "executeCopy";
export const EXEC_COPY_POPUP = "executeCopyPopup";
export const EXEC_COPY_TABS_ALL = "executeCopyAllTabs";
export const EXEC_COPY_TABS_ALL_POPUP = "executeCopyAllTabsPopup";
export const EXEC_COPY_TABS_SELECTED = "executeCopyAllTabs";
export const EXEC_COPY_TABS_SELECTED_POPUP = "executeCopyAllTabsPopup";
