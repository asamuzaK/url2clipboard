[EN](./README.md) | [JA](./README.ja.md) | ZH
...
将 URL 格式化为多种格式（目前支持HTML、Markdown、BBCode、Textile、AsciiDoc、MediaWiki、DokuWiki、Jira、reStructuredText、LaTeX、Org Mode、纯文本），然后再复制到剪贴板。
